...
for (i in 1:length(CPG_all)) {
  tryCatch({
    ...
    svace <- SatFit$MZ.expCovMZ[1,1]$values/3
      ...
      AdeSumm$CI[1,1] <- AdeSumm$CIdetail[1,3]
      AdeSumm$CI[1,3] <- AdeSumm$CIdetail[2,3]
      AdeSumm$CI[2,1] <- AdeSumm$CIdetail[3,3]
      AdeSumm$CI[2,3] <- AdeSumm$CIdetail[4,3]
      AdeSumm$CI[3,1] <- AdeSumm$CIdetail[5,3]
      AdeSumm$CI[3,3] <- AdeSumm$CIdetail[6,3]
      ...
      result[vart,'model2'] <- 'ADE'
      result[vart,6] <- round(AdeSumm$CI[,c(2,1,3)] , 2 )[4,1]
      result[vart,7] <- round(AdeSumm$CI[,c(2,1,3)] , 2 )[4,2]
      result[vart,8] <- round(AdeSumm$CI[,c(2,1,3)] , 2 )[4,3]
      result[vart,9] <- round(AdeSumm$CI[,c(2,1,3)] , 2 )[5,1]
      result[vart,10] <- round(AdeSumm$CI[,c(2,1,3)] , 2 )[5,2]
      result[vart,11] <- round(AdeSumm$CI[,c(2,1,3)] , 2 )[5,3]
      result[vart,12] <- round(AdeSumm$CI[,c(2,1,3)] , 2 )[6,1]
      result[vart,13] <- round(AdeSumm$CI[,c(2,1,3)] , 2 )[6,2]
      result[vart,14] <- round(AdeSumm$CI[,c(2,1,3)] , 2 )[6,3]
      result[vart,15] <- round(AdeSumm$CI[,c(2,1,3)] , 2 )[1,1]
      result[vart,16] <- round(AdeSumm$CI[,c(2,1,3)] , 2 )[1,2]
      result[vart,17] <- round(AdeSumm$CI[,c(2,1,3)] , 2 )[1,3]
      result[vart,18] <- round(AdeSumm$CI[,c(2,1,3)] , 2 )[2,1]
      result[vart,19] <- round(AdeSumm$CI[,c(2,1,3)] , 2 )[2,2]
      result[vart,20] <- round(AdeSumm$CI[,c(2,1,3)] , 2 )[2,3]
      result[vart,21] <- round(AdeSumm$CI[,c(2,1,3)] , 2 )[3,1]
      result[vart,22] <- round(AdeSumm$CI[,c(2,1,3)] , 2 )[3,2]
      result[vart,23] <- round(AdeSumm$CI[,c(2,1,3)] , 2 )[3,3]
  }, error = function(e) {print(paste("error",i,sep=" "))})
}
write.csv(result,file = '/public/home/hongxming/uni_bmi/results_bmi_longi1_ade_o.csv')
