...
bi_bmi_1_result <- read.csv('/public/home/hongxming/bmi_ace/bi_bmi_1_result.csv')
...
write.csv(lonresult,file = '/public/home/hongxming/bmi_ace/bi_bmi_results_2_compare.csv')
