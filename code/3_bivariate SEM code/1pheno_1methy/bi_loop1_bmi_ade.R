...
PHENO_1 <- subset(PHENO_1,select=c(ID20,BMI_1))
...
for (i in 1:length(CPG_all)) {
    ...
    # Run AE model
      ...
      fitcompare <- mxCompare(fitADE, c(AEfit,dropRdfit))
...
write.csv(result,file = '/public/home/hongxming/bmi_ace/bi_bmi_results_1_ade.csv')
